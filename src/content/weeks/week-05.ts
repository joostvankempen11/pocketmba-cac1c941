  ...
  lessons: [
    {
      ...
      videos: [
        { title: "Segmentation, targeting, positioning (search)", source: "YouTube search", fallbackSearchQuery: "segmentation targeting positioning explained" },
    ...
    },
    {
      ...
      videos: [
        { title: "Marketing mix — the 4 Ps (search)", source: "YouTube search", fallbackSearchQuery: "marketing mix 4 Ps explained" },
    ...
    },
    {
      ...
      videos: [
        { title: "Customer lifetime value (search)", source: "YouTube search", fallbackSearchQuery: "customer lifetime value explained" },
